      ...
      <div className="footer-container">
        ...
        <div className="footer-main">
          ...
          <div className="footer-brand">
            <h3>Ahava</h3>
            <p>
              Criando experiências digitais extraordinárias que conectam pessoas, 
              inspiram comunidades e geram mudanças significativas no mundo.
            </p>
        ...
        <div className="newsletter-section">
          <div className="newsletter-container">
            <h4 className="newsletter-title">Mantenha-se Atualizado</h4>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            © {currentYear} Ahava. Todos os direitos reservados.
          </p>
